...
function Post(props){
  ...
  const [textoComentario, setTextoComentario] = useState('Comentário')

  const handleTextoComentario = (event) => {
  ...
  let iconeCurtida
    ...
    if(comentando) {
      componenteComentario = <SecaoComentario aoEnviar={aoEnviarComentario}  onChangeComentario={handleTextoComentario}/>
    }
